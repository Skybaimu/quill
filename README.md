...
| v2 | 2026-04-11 01:52 | Grid布局、收藏区、折叠动画、搜索增强、Markdown分栏、Teleport菜单、auto-grow |
| **v3** | **2026-04-11 09:18** | **搜索高亮+内容块过滤、快捷键、导入导出、时间显示、Markdown拖拽、标签自动分配** |
